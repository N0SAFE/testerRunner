const { searchInObject, removeInObject, addInObject, parse, notFoundsTypesDeclarator } = require("./bundle.js");
const { notFoundsTypesDeclarator } = require("./typesDeclarator/_.js");
const { primitiveValue } = require("./primitiveValue/function.js");

class Undefined {}
class HandleTypeVerif {
 ...
 */
function verif(obj, constraint, { error, success } = {}) {
    let last = {};
